...
If you do not have one yet, create a free account at [github.com](https://github.com). Once you have an account, we strongly recommend registering for the **GitHub Student Developer Pack**, which gives you access to a range of professional tools for free:
...
1. Go to the course material repository on GitHub (link shared in Session 1)

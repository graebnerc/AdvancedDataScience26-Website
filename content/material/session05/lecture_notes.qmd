...
::: {.callout-note}
Place `morg-2014-emp.csv` in a `data/` subfolder next to this file before rendering.
The data file is the same raw CPS MORG extract used in the Session 5 exercise.
:::
